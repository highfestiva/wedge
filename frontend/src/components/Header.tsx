    ...
    <header data-testid="header" className="app-header">
      ...
      <div className="flex items-center gap-3">
        ...
        {onCreateIssue && (
          ...
          >
            <svg className="h-5 w-5 text-t-muted group-hover:text-accent-soft transition-colors" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
