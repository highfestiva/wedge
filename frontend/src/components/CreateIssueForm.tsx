...
export const CreateIssueForm: React.FC<CreateIssueFormProps> = ({
  ...
  return (
    <form data-testid="create-issue-form" onSubmit={handleSubmit} className="section-card mx-auto max-w-lg space-y-4">
      <h2 className="text-lg font-semibold text-slate-100 tracking-tight">Create Issue</h2>
      ...
      {validationError && (
        <div data-testid="validation-error" className="rounded-lg border border-red-500/20 bg-red-950/30 px-3 py-2 text-xs text-red-300">
          {validationError}
        </div>
      )}
